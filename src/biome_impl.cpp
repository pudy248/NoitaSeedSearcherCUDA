...
static BiomeSpawnColors DefaultSpawnColors({0x78ffff, 0x55ff8c, 0x50a000});
_data static BiomeSpawnFunctions DefaultSpawnFunctions(NULL, {spawnHeart, spawnChest, spawnPotion});
...
BiomePixelScenes Scenes({
	...
	PixelSceneList({
		...
		PixelSceneData(PS_COALMINE_WANDTRAP_H_04, 0.75f, "data/biome_impl/coalmine/wandtrap_h_04.png",
			{OIL, ALCOHOL, GUNPOWDER_EXPLOSIVE}),
		PixelSceneData(PS_COALMINE_WANDTRAP_H_06, 0.75f, "data/biome_impl/coalmine/wandtrap_h_06.png",
			{MAGIC_LIQUID_TELEPORTATION, MAGIC_LIQUID_POLYMORPH, MAGIC_LIQUID_RANDOM_POLYMORPH, RADIOACTIVE_LIQUID}),
		PixelSceneData(PS_COALMINE_WANDTRAP_H_07, 0.75f, "data/biome_impl/coalmine/wandtrap_h_07.png",
			{WATER, OIL, ALCOHOL, RADIOACTIVE_LIQUID}),
	...
	PixelSceneList({
		// g_oiltank
		PixelSceneData(PS_COALMINE_OILTANK_1, 1.0f, "data/biome_impl/coalmine/oiltank_1.png",
			{WATER, OIL, WATER, OIL, ALCOHOL, SAND, COAL, RADIOACTIVE_LIQUID}),
		PixelSceneData(PS_COALMINE_OILTANK_1, 0.0004f, "data/biome_impl/coalmine/oiltank_1.png",
		...
		PixelSceneData(PS_COALMINE_OILTANK_2, 0.01f, "data/biome_impl/coalmine/oiltank_2.png",
			{BLOOD_FUNGI, BLOOD_COLD, LAVA, POISON, SLIME, GUNPOWDER_EXPLOSIVE, SOIL, SALT, BLOOD, CEMENT}),
		PixelSceneData(PS_COALMINE_OILTANK_2, 1.0f, "data/biome_impl/coalmine/oiltank_2.png",
			{WATER, OIL, WATER, OIL, ALCOHOL, OIL, COAL, RADIOACTIVE_LIQUID}),
		PixelSceneData(PS_COALMINE_OILTANK_3, 1.0f, "data/biome_impl/coalmine/oiltank_3.png",
			{WATER, OIL, WATER, OIL, ALCOHOL, WATER, COAL, RADIOACTIVE_LIQUID, MAGIC_LIQUID_TELEPORTATION}),
		PixelSceneData(PS_COALMINE_OILTANK_4, 1.0f, "data/biome_impl/coalmine/oiltank_4.png",
			{WATER, OIL, WATER, OIL, ALCOHOL, SAND, COAL, RADIOACTIVE_LIQUID, MAGIC_LIQUID_POLYMORPH}),
		PixelSceneData(PS_COALMINE_OILTANK_5, 1.0f, "data/biome_impl/coalmine/oiltank_5.png",
	...
	PixelSceneList({
		// g_oiltank_alt
		PixelSceneData(PS_COALMINE_OILTANK_ALT, 1.0f, "data/biome_impl/coalmine/oiltank_alt.png",
...
static BiomeSpawnColors Colors({0x00ff00, 0xff0aff, 0xff0080});
_data static BiomeSpawnFunctions Funcs(NULL, {spawn_item, spawn_pixel_scene_01, spawn_pixel_scene_02});
};
...
BiomePixelScenes Scenes(
	{PixelSceneList({
		...
		PixelSceneList({
			...
			PixelSceneData(
				PS_EXCAVATIONSITE_RECEPTACLE_STEAM, 0.7f, "data/biome_impl/excavationsite/receptacle_steam.png"),
		...
		PixelSceneList({
			// g_gunpowderpool_01
			PixelSceneData(
				PS_EXCAVATIONSITE_GUNPOWDERPOOL_01, 1.5f, "data/biome_impl/excavationsite/gunpowderpool_01.png"),
		}),
		PixelSceneList({
			// g_gunpowderpool_02
			PixelSceneData(
				PS_EXCAVATIONSITE_GUNPOWDERPOOL_02, 1.5f, "data/biome_impl/excavationsite/gunpowderpool_02.png"),
		}),
		PixelSceneList({
			// g_gunpowderpool_03
			PixelSceneData(
				PS_EXCAVATIONSITE_GUNPOWDERPOOL_03, 1.5f, "data/biome_impl/excavationsite/gunpowderpool_03.png"),
		}),
		PixelSceneList({
			// g_gunpowderpool_04
			PixelSceneData(
				PS_EXCAVATIONSITE_GUNPOWDERPOOL_04, 1.5f, "data/biome_impl/excavationsite/gunpowderpool_04.png"),
		}),
		PixelSceneList({
			PixelSceneData(PS_EXCAVATIONSITE_MEDITATION_CUBE, 1, nullptr),
		})});
...
_data static BiomeSpawnFunctions Funcs(
	NULL, {spawn_item, spawn_pixel_scene_01, spawn_pixel_scene_02, spawn_pixel_scene_04, spawn_pixel_scene_04_alt,
			  spawn_puzzleroom, spawn_gunpowderpool_01, spawn_gunpowderpool_02, spawn_gunpowderpool_03,
			  spawn_gunpowderpool_04, spawn_meditation_cube});
};
...
BiomePixelScenes Scenes({
	...
	PixelSceneList({
		...
		PixelSceneData(
			PS_SNOWCAVE_VERTICALOBSERVATORY_ALT, 0.5f, "data/biome_impl/snowcave/verticalobservatory_alt.png"),
		PixelSceneData(
			PS_SNOWCAVE_VERTICALOBSERVATORY2_ALT, 0.5f, "data/biome_impl/snowcave/verticalobservatory2_alt.png"),
...
BiomePixelScenes Scenes({
	...
	PixelSceneList({
		// g_pixel_scene_02
		PixelSceneData(PS_VAULT_LAB, 0.5f, "data/biome_impl/vault/lab.png",
			{RADIOACTIVE_LIQUID, RADIOACTIVE_LIQUID, ACID, ACID, ACID, ALCOHOL}),
		PixelSceneData(PS_VAULT_LAB2, 0.5f, "data/biome_impl/vault/lab2.png",
			{RADIOACTIVE_LIQUID, RADIOACTIVE_LIQUID, ACID, ACID, ACID, ALCOHOL}),
		PixelSceneData(PS_VAULT_LAB3, 0.5f, "data/biome_impl/vault/lab3.png",
			{RADIOACTIVE_LIQUID, RADIOACTIVE_LIQUID, ACID, ACID, ACID, ALCOHOL}),
...
static BiomeSpawnColors Colors({0x00ff00, 0xff0aff, 0xff0080, 0x692e94, 0x822e5b});
_data static BiomeSpawnFunctions Funcs(NULL, {
												 spawn_item,
												 spawn_pixel_scene_01,
												 spawn_pixel_scene_02,
...
static BiomeSpawnColors Colors({0x00ff00, 0xff0aff, 0x00ac33, 0x97ab00, 0xc9d959});
_data static BiomeSpawnFunctions Funcs(NULL, {
												 spawn_item,
												 spawn_pixel_scene_01,
												 spawn_pixel_scene_03,
...
BiomePixelScenes Scenes({
	PixelSceneList({
		// g_pixel_scene_01
		PixelSceneData(PS_LIQUIDCAVE_CONTAINER_01, 0.5f, "data/biome_impl/liquidcave/container_01.png",
...
static BiomeSpawnColors Colors({0xff0aff});
_data static BiomeSpawnFunctions Funcs(NULL, {
												 spawn_pixel_scene_01,
											 });
